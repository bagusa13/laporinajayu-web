...
if (window.matchMedia("(min-width: 1024px) and (hover: hover)").matches) {
    ...
    // Attach hover to elements initially
    const attachHover = () => {
        const interactables = document.querySelectorAll('a, button, input, select, textarea, .stat-card, .nav-item');
    ...
    attachHover();
    // Re-attach if DOM changes (like after login)
